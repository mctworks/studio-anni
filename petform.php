...
<body>
    ...
    <div class="page-header">
      <h2 class="gdfg">Pet Portrait Request Form</h2>
    </div>
    ...
    <div class="form-group">
      <label class="col-sm-6 control-label" for="textinput">Please briefly tell us what you're looking for in a pet portrait</label>
      <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
          <textarea name="petform_message" id="petform_message" rows="8" placeholder="Talk About Your Pet!" class="form-control" required></textarea>
      </div>
    </div>

    <div class="form-group">
        <label class="col-sm-6 control-label" for="textinput">Upload a Picture of Your Pet</label>
      <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
    ...
    <div class="form-group">
        <label class="col-sm-6" for="textinput">Second Pet Photo (Optional)</label>
      <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
    ...
    <div class="form-group">
        <label class="col-sm-6" for="textinput">Third Pet Photo (Optional)</label>
      <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
    ...
    <div class="form-group">
        <label class="col-sm-6" for="textinput">Fourth Pet Photo (Optional)</label>
      <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
    ...
    <div class="form-group">
        <label class="col-sm-6" for="textinput">Fifth Pet Photo (Optional)</label>
      <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
        <input type='file' id="petpic5" name="petpic5" class="form-control">
      </div>
    </div>
    
    <label><input type="submit" class="purchaseButton" name="button" id="submit" value="Send Pet Portrait Request!" /></label>
    </fieldset>
    </div></div>
</form>
</body>
